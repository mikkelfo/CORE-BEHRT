...
def main():
    ...
    data_dir = "data/tokenized/hierarchical/small_test"
    # Load concepts
    ...
    print("Tokenize")
    tokenizer = H_EHRTokenizer(config=tokenizer_config, test=False)
    ...
    tree.populate_tree(features['concept'])

    print("Create datasets")
    # To dataset
    dataset_kwargs = {'vocabulary': tokenizer.vocabulary, 'h_vocabulary': tokenizer.h_vocabulary,
            'leaf_nodes':tokenizer.get_leaf_nodes(), 'base_leaf_probs':tree.counts}
