...
python3 src/scripts/data_pretrain.py loader.data_dir=data/synthea paths.data_dir=data/test_processed paths.extra_dir=data/test_extra_dir
...
python3 src/scripts/outcomes.py loader.data_dir=data/synthea paths.data_dir=data/test_processed paths.extra_dir=data/test_extra_dir
python3 src/scripts/data_finetune.py loader.data_dir=data/synthea paths.data_dir=data/test_processed paths.extra_dir=data/test_extra_dir
